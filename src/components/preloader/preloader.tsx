...
import preLoaderAnim from '../../assets/animation/animation.ts';
import './preloader.css';  // Adjust the path based on your project structure
import '../../assets/utils/utils.css';  // Adjust the path based on your project structure
        ...
        <div className='preloader'>
            ...
            <div className="rest italic font-bold text-2xl">
                ...
                <div className="heading">
                    <h1 className='text-5xl pb-5 pt-2 pl-5'>Stavya 2024</h1>
                </div>
                <div className="table">
